...
print("is implicant_BN?:", explainer.is_implicant_BT(bn))
print("predict_implicant_BN",explainer.get_model().predict_implicant(bn))
print("to_feature",explainer.to_features((-9,)))
print("to_feature",explainer.to_features((-15,)))
